...
## Cách cài đặt
    1. git clone https://github.com/TienManh-Manilife/Student_Score_Analyzer
    2. pip install -r requirements.txt (Sau khi cài và mở venv)
    3. Chạy file main.py
## Yêu cầu
Không
## Cấu trúc thư mục
...
<img src="./resources/outputimages/app.png" width=50%>
<img src="./resources/outputimages/menu_screen.png" width=50%>
...
<img src="./resources/outputimages/database_screen.png" width=50%>

### Thao tác trong tất cả lớp học
    1. Hiện tất cả mã lớp học
    2. Hiện tất cả mã lớp học trong 1 học kỳ
<img src="./resources/outputimages/all_classes_screen.png" width=50%>

### Thao tác trong 1 lớp học
    1. Hiện tên lớp học
    2. Hiện điểm trung bình các sinh viên trong 1 lớp
<img src="./resources/outputimages/a_class_screen.png" width=50%>

### Thao tác trong tất cả sinh viên
    1. Hiện thông tin tất cả sinh viên
<img src="./resources/outputimages/all_students_screen.png" width=50%>
...
<img src="./resources/outputimages/a_student_screen.png" width=50%>

### Cách quy đổi
    Hiện quy đổi các đầu điểm
<img src="./resources/outputimages/conversion_screen.png" width=50%>
...
<img src="./resources/outputimages/change_data_screen.png" width=50%>
